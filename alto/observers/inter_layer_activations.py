...
@register_observer("inter_layer_activations")
class InterLayerActivationsObserver(Observer):
    """
    Inter-layer activations observer: collects the raw layer activations between two layers during calibration.
    Each forward activation is concatenated along dim=0 (batch), e.g. single activation
