...
def get_quantizable_layers(module: Module) -> Dict[str, Module]:
    if QATLinear is None:
        raise ImportError("PyTorch version is not setup for Quantization. "
...
# def get_layers_params(targets: Union[str, List[str]],
#                       module: Module) -> Dict[str, ModelParameterizedLayer]:
#     params = get_params(targets, module)
#     layers = get_layers(targets, module)

#     parameterized_layers = {}
#     for name, param in params.items():
#         param_layer = ModelParameterizedLayer(layer_name=name,
#                                               layer=layers[name],
#                                               param_name=name,
#                                               param=param)
