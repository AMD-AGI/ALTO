# copied from https://github.com/vllm-project/llm-compressor/blob/f3f14af3ee56e35db7e1faf6da8833f84a570baf/src/llmcompressor/pytorch/utils/sparsification.py
...
from .helpers import get_quantized_layers, tensor_sparsity
