# copied from https://github.com/NVIDIA/Model-Optimizer/blob/452c5a09b03f8db34a39151aae4f7a4b01efd9cd/modelopt/torch/distill/loss_balancers.py
...
class StaticLossBalancer(DistillationLossBalancer):
    ...
    def forward(self, loss: dict[str, torch.Tensor]) -> torch.Tensor:
        ...
        aggregate_loss = sum(loss * weight for loss, weight in zip(
            kd_loss_dict.values(), self._kd_loss_weight))
