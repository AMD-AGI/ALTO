...
from modeloptimizer.utils.pytorch.sparsification import ModuleSparsificationInfo
from modeloptimizer.utils.compression.helpers import (
    ...
    def is_sparse24_bitmask_supported(
        ...
        for submodule in model.modules():
            ...
            if weight_scheme and input_scheme:
                ...
                logger.info("Weight only quantization detected, "
                            "turning off sparse 24 compression.")
                return False
