...
def _load_quantization_modifier():
    ...
    points, so the test loads the required modules directly.
    """
...
def _load_mx9_modifier_from_recipe():
...
def test_mx9_wa_recipe_toy_linear_lifecycle(monkeypatch):
    modifier, quantize_mod = _load_mx9_modifier_from_recipe()
